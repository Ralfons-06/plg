 ...
 */
public class NewMultipleProcessDialog extends GeneralDialog {
	...
	protected JSpinner countSpinner = null;
	 ...
	 */
	protected NewMultipleProcessDialog(String candidateProcessName, JFrame owner, String title, String help, final ConfigurationSet configuration) {
		...
		countSpinner = new JSpinner(new SpinnerNumberModel(
				configuration.getInteger(KEY_COUNTER, DEFAULTS.getMaximumDepth()), 1, 2000, 1));
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				configuration.setInteger(KEY_COUNTER, Integer.parseInt(countSpinner.getValue().toString()));
				...
				numberOfProcesses = Integer.parseInt(countSpinner.getValue().toString());
				...
				NewMultipleProcessDialog.this.dispose();
			}
		});
		...
		//number of processes
		bodyPanel.add(prepareFieldLabel("Number of Processes"));
		bodyPanel.add(countSpinner);
	 ...
	 */
	public NewMultipleProcessDialog(JFrame owner, String candidateName) {
		this(candidateName, owner,
			"New Random Process Configuration",
			"Use this dialog to set the new process parameters.",
			ApplicationController.instance().getConfiguration(NewMultipleProcessDialog.class.getCanonicalName()));
	}
