 ...
 */
public class AllLogsDialog extends GeneralDialog {
	 ...
	 */
	protected AllLogsDialog(String candidateProcessName, JFrame owner, String title, String help, final ConfigurationSet configuration, boolean showLogNameAndTraces) {
	 ...
	 */
	public AllLogsDialog(JFrame owner, String candidateName) {
		this(candidateName, owner,
			"Simulation Configuration",
			"Use this dialog to configure the simulation of a process.",
			ApplicationController.instance().getConfiguration(AllLogsDialog.class.getCanonicalName()),
			true);
	}
